...
<div class="container-fluid">	
	<h3>Shows</h3>
	<div class="jumbotron">
		<p>George Diamond's shows and specialty acts have been designed and structured so as to deliver an unforgettable magical entertainment, by the highest standards of the entertainment industry. His performances are family oriented, and they appeal to audiences of different nationalities, age, and interest groups worldwide. George's pricing structure will also ensure you get the highest value for money possible with this level and quality of entertainment! The shows George performs come in following formats:​​</p>
		<ul id="amazing-shows-list">
	        <li><a href="#" class="amazing-show">full scale illusion shows</a></li>
	        <li><a href="#" class="amazing-show">smaller scale stage shows</a></li>
	        <li><a href="#" class="amazing-show">corporate &amp; private events shows</a></li>
	        <li><a href="#" class="amazing-show">quickchange act</a></li>
	        <li><a href="#" class="amazing-show">chinese mask change act</a></li>
	        <li><a href="#" class="amazing-show">various short acts</a></li>
	        <li><a href="#" class="amazing-show">parlor magic</a></li>
	        <li><a href="#" class="amazing-show">magic for kids</a></li>
      </ul>
	</div>
	<div class="row show-box">
		...
		<div class="col-sm-6 shows-misc">
			...
			<a href="#" class="btn btn-round btn-info">Watch Video</a>
		</div>
	</div>
